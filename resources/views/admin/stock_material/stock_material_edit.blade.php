                        ...
                        <div class="card">
                            ...
                            <form role="form" action="" method="post" id="coustomer_add"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="destination_location">Machine</label>
                                        <input type="text" class="form-control" value="{{ $user->machine_name }}"
                                            readonly />
                                    </div>
                                    <div class="form-group">
                                        <label for="destination_location">Marka</label>
                                        <input type="text" class="form-control" value="{{ $user->marka }}"
                                            readonly />
                                    </div>
                                    <h5>Consumption</h5>
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <td width="12%">Color Item</td>
                                                <td width="12%">Color Rate Per Gram</td>
                                                <td width="12%">Color Gram</td>
                                                <td width="12%">Color amount</td>
                                            </tr>
                                        </thead>
                                        <tbody id="consumption">
                                            @foreach ($stockcolor as $stockcolors)
                                                <tr>
                                                    <td>{{ $stockcolors->color_name }}</td>
                                                    <td>{{ $stockcolors->rate }}</td>
                                                    <td>{{ $stockcolors->gram }}</td>
                                                    <td>{{ $stockcolors->rate * $stockcolors->gram }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <td width="12%">Chemical Item</td>
                                                <td width="12%">Chemical Rate Per Gram</td>
                                                <td width="12%">Chemical Gram</td>
                                                <td width="12%">Chemical amount</td>
                                            </tr>
                                        </thead>
                                        <tbody id="consumption">
                                            @foreach ($stockchemical as $stockchemicals)
                                                <tr>
                                                    <td>{{ $stockchemicals->name }}</td>
                                                    <td>{{ $stockchemicals->rate }}</td>
                                                    <td>{{ $stockchemicals->gram }}</td>
                                                    <td>{{ $stockchemicals->rate * $stockchemicals->gram }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <div class="form-group mt-2">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <p>Color Item Total Amount</p>
                                            </div>
                                            <?php
                                            $colortotal = 0;
                                            
                                            foreach ($stockcolor as $stockcolors) {
                                                $colortotal += $stockcolors->rate * $stockcolors->gram;
                                            }
                                            ?>
                                            <div class="col">
                                                <input type="input" class="form-control"
                                                    id="consumption_total_item_amount" name="consumption_total_item_amount"
                                                    value="{{ $colortotal }}" placeholder="Final Total Amount"
                                                    readonly />
                                            </div>
                                            <div class="col">
                                    ...
                                    <div class="form-group mt-2">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <p>Chemical Item Total Amount</p>
                                            </div>
                                            <?php
                                            $chemicaltotal = 0;
                                            
                                            foreach ($stockchemical as $stockchemicals) {
                                                $chemicaltotal += $stockchemicals->rate * $stockchemicals->gram;
                                            }
                                            ?>
                                            <div class="col">
                                                <input type="input" class="form-control"
                                                    id="consumption_total_item_amount" name="consumption_total_item_amount"
                                                    value="{{ $chemicaltotal }}" placeholder="Final Total Amount"
                                                    readonly />
                                            </div>
                                            <div class="col">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <input type="input" class="form-control" id="consuption_total_amount"
                                                    name="consuption_total_amount" value="{{ $consumptiontotal + $overheadtotaltotal + $chemicaltotal + $colortotal}}"
                                                    placeholder="Final Total Amount" readonly />
                                            </div>
                                            <div class="col">
