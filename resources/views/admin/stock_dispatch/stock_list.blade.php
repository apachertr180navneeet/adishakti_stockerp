...
@section('title', 'Stock Shifting List')
@section('content')
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Stock Shifting List</h1>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active">Stock Shifting List</li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h3 class="card-title">Stock Shifting List</h3>
                                            </div>
                                            <div class="col-md-5">
                                            </div>
                                            <div class="col-md-1">
                                    ...
                                    <div class="card-body">
                                        <table id="customer_list" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                @php
                                                    $branchfrom = DB::table('company')->where('id', '=', $stock->from_id)->first();
                                                @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @php
                                                            $branchto = DB::table('company')->where('id', '=', $stock->branch_to_id)->first();
                                        ...
                                        <div class="d-flex justify-content-center">
                                            {!! $stockDispatchList->links('pagination::bootstrap-4') !!}
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                                </div>
