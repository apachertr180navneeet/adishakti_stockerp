            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Chemical Report</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="card-title">Chemical Report</h3>
                                </div>
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{ route('admin.chemical.report.filter') }}" method="get">
                                <div class="row mb-2">
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-md-12 text-center">
                                    <h4>Adisakti | Chemical Report</h4>
                                    ...
                                    <table id="customer_list" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $stockoutqty = DB::table('stock_meterial_chemical')
                                                        ->select('stock_meterial_chemical.chemical_item_id','stock_meterial_chemical.gram')
                                                        ->where('stock_meterial_chemical.chemical_item_id',$report->color_id)
                                                        ->sum('gram');
