                            ...
                            <form role="form" action="{{ route('admin.condition.update') }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control select2bs4 select2-hidden-accessible" name="unit_id" style="width: 100%;" aria-hidden="true" required>
                                                ...
                                                <option value="{{ $unit->id }}" {{ $unit->id == $user->unit ? 'selected' : $user->unit }}>{{ $unit->unit_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @error('unit_id')
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="value" name="value"
                                                value="{{ $user->value }}" placeholder="Enter Rate Per Meter" required />
                                            @error('value')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="metervalue" name="metervalue"
                                                value="{{ $user->meter_value }}" placeholder="Enter meter value" readonly />
                                            @error('name')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                {{--  <table class="table table-bordered">
                                    ...
                                    <tbody id="quoteTableBody">
                                        ...
                                        @foreach ($userGet as $stockItemList)
                                        <tr>
                                            <td>
