...
class ItemController extends Controller
{
    public function index(){
        if(Auth::check()){
            ...
            $item_list = Item::select('item.id','item.item_name','item.item_description','item.open_stock','unit.unit_code','item.status')->join('unit', 'item.unit_id', '=', 'unit.id')->orderBy('item.item_name', 'ASC')->get();
